    ...
    methods( Access = private )
        function computeImStats( this )
            ...
            try
                ...
                imStats_.averageImage = averageImage;
                imStats_.rgbMean = reshape( rgbMean, 1, 1, 3 );
                imStats_.rgbCovariance = rgbCovariance;
